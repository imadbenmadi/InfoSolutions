...
function Footer() {
  return (
    <div className="flex w-full flex-col items-center bg-Blue text-center text-surface dark:text-white">
      ...
      <div className="w-full bg-Blue p-4 text-center">
        © {currentYear} Copyright : <a href="https://tw-elements.com/">CNTIC</a>
      </div>
    </div>
  );
}
